...
$(document).ready(function(){
	...
	$("#submitBtn").click(function(){
		if(validation()){
			...
			alert("Errors : Please Fill the Required Fields marked with Red Border");
		}
	});
...
<title>New Contract Input</title>
</head>
<body>
	...
	<div class="container">
	<h3 class="heading">New Contract Entry</h3>
	<div>
...
<table align="center" >
	<tr>
	<td><div class="buttondiv"><input type="button" value="Submit" id="submitBtn" style="float: right;"></div></td>
